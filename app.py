...
st.markdown("""
    ...
    .header-text {
        ...
        text-align: center;
        text-shadow: 2px 2px 15px rgba(0,0,0,1); /* Strong shadow */
        font-weight: 800;
    }
    ...
    /* 4. RESULTS BOX - PURE WHITE WITH BLACK TEXT */
    .itinerary-container {
        background: #FFFFFF !important; 
        padding: 40px;
        border-radius: 15px;
        color: #1A1A1A !important; /* Deep black text */
        line-height: 1.8;
        font-size: 1.1rem;
    ...
    table { width: 100%; background: white !important; border: 1px solid #ddd; }
    th { background: #f0f0f0 !important; color: black !important; font-weight: bold; padding: 10px; }
    td { border-bottom: 1px solid #eee !important; color: black !important; padding: 10px; }
...
with st.sidebar:
    ...
    st.info("మీ యాత్ర వివరాలను బాక్స్‌లో టైప్ చేసి బటన్ నొక్కండి. నిమిషాల్లో ప్లాన్ సిద్ధమవుతుంది.")
...
# --- 5. UI LAYOUT ---
st.markdown('<h1 class="header-text" style="font-size: 4rem; margin-top: -50px;">🚩 YatriMate AI</h1>', unsafe_allow_html=True)
st.markdown('<p class="header-text" style="font-size: 1.5rem; margin-bottom: 40px;">మీ పర్సనల్ ట్రావెల్ ఏజెంట్ - Gemini 3 Edition</p>', unsafe_allow_html=True)
